...
> 来源：https://docs.nocobase.com/cn/data-sources/data-modeling/collection-fields/media/markdown
> 整理时间：2026-09-02
...
如果需要所见即所得编辑体验，可以选择富文本或 Markdown Vditor。
...
* Markdown Vditor — 使用 Vditor 编辑 Markdown
* 富文本 — 使用富文本编辑内容
* 多行文本 — 保存纯文本长内容
